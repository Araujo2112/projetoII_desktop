...
public class PagamentoService {
    ...
    public Pagamento getPagamentoById(Integer id) throws IOException, InterruptedException {
        HttpRequest request = HttpRequest.newBuilder()
    ...
    public Pagamento createPagamento(Pagamento pagamento) throws IOException, InterruptedException {
    ...
    public Pagamento updatePagamento(Integer id, Pagamento pagamento) throws IOException, InterruptedException {
        String json = gson.toJson(pagamento);
    ...
    public void deletePagamento(Integer id) throws IOException, InterruptedException {
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(BASE_URL + "/" + id))
                .DELETE()
                .build();
